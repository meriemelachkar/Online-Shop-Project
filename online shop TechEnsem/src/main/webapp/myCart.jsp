...
%>
          ...
          <tr>
            <th scope="col" style="background-color: yellow;">Total: <%out.println(total); %> mad</th>
      ...
      %>
		...
		<% sno = sno + 1; %>
           <td><%out.println(sno); %></td>
            ...
            <td><a href="incDecQuantityAction.jsp?id=<%=rs.getString(1)%>&quantity=inc">+ </a><%=rs.getString(9) %><a href="incDecQuantityAction.jsp?id=<%=rs.getString(1)%>&quantity=dec"> -</a></td>
